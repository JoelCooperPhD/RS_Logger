...
from tkinter.ttk import Notebook, LabelFrame, Frame, Checkbutton, Spinbox, Style
from tkinter import Label
import win32com.client
import cv2
from multiprocessing import Process, Pipe, Value, Queue
from user_interface.usb_cameras import cam_win
...
class CameraWidget:
    def __init__(self, root_win, widget_frame, q_out):
        self._win = root_win
        self._q_out = q_out
