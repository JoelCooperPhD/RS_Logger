...
class BaseDRT:
    ...
    HEADERS = "Device ID,Label,Unix time in UTC,Block Microseconds,Trial Number,Reaction Time Microseconds,Response Count,Battery Percent,Device time in UTC\n"
    ...
    def _send_results(self):
        ...
        results = f"dta>{block_run_ms},{self._trial_number},{self._reaction_time},{self._response_n}"
        if self._broadcast:
